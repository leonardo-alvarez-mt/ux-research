      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            ...
            <h3
              className="font-semibold text-slate-900 text-sm leading-snug cursor-pointer hover:text-blue-600 transition-colors"
        ...
        <div className="flex items-center gap-2 text-xs text-slate-500 mb-4">
          ...
          <span>Test Date: {formatDate(session.test_date)}</span>
        </div>
          ...
          <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
            <div
              className={`h-full rounded-full transition-all duration-500 ${
                progress === 100 ? 'bg-emerald-500' : progress > 50 ? 'bg-blue-500' : 'bg-blue-400'
              }`}
